...
On changing the value of the `question` field, a state for it is set, which we specified as our custom `onChange` logic. Then, the input type of the `answer` field is rendered accordingly. Also, submit the form and look at your browser console! The correct value of the field is attached.